...
export default function useCosmosBankV1Beta1() {
  ...
  return {
    QueryBalance, QueryAllBalances, QuerySpendableBalances, QuerySpendableBalanceByDenom, QueryTotalSupply, QuerySupplyOf, QueryParams, QueryDenomMetadata, QueryDenomsMetadata, QueryDenomOwners, QuerySendEnabled,
  }
}