...
export default function useCosmosGroupV1() {
  ...
  return {
    QueryGroupInfo, QueryGroupPolicyInfo, QueryGroupMembers, QueryGroupsByAdmin, QueryGroupPoliciesByGroup, QueryGroupPoliciesByAdmin, QueryProposal, QueryProposalsByGroupPolicy, QueryVoteByProposalVoter, QueryVotesByProposal, QueryVotesByVoter, QueryGroupsByMember, QueryTallyResult, QueryGroups,
  }
}