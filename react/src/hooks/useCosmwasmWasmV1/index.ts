...
export default function useCosmwasmWasmV1() {
  ...
  return {
    QueryContractInfo, QueryContractHistory, QueryContractsByCode, QueryAllContractState, QueryRawContractState, QuerySmartContractState, QueryCode, QueryCodes, QueryPinnedCodes, QueryParams, QueryContractsByCreator,
  }
}