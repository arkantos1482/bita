...
export default function useCosmosDistributionV1Beta1() {
  ...
  return {
    QueryParams, QueryValidatorDistributionInfo, QueryValidatorOutstandingRewards, QueryValidatorCommission, QueryValidatorSlashes, QueryDelegationRewards, QueryDelegationTotalRewards, QueryDelegatorValidators, QueryDelegatorWithdrawAddress, QueryCommunityPool,
  }
}