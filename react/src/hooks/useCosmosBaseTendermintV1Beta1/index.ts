...
export default function useCosmosBaseTendermintV1Beta1() {
  ...
  return {
    ServiceGetNodeInfo, ServiceGetSyncing, ServiceGetLatestBlock, ServiceGetBlockByHeight, ServiceGetLatestValidatorSet, ServiceGetValidatorSetByHeight, ServiceABCIQuery,
  }
}