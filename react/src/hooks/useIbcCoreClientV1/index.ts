...
export default function useIbcCoreClientV1() {
  ...
  return {
    QueryClientState, QueryClientStates, QueryConsensusState, QueryConsensusStates, QueryConsensusStateHeights, QueryClientStatus, QueryClientParams, QueryUpgradedClientState, QueryUpgradedConsensusState,
  }
}